      ...
      <div className="max-w-[1100px] w-full mx-auto">
        <div className="flex justify-between">
          <div className="bg-[] w-1/2">
            ...
            <form className="flex justify-start gap-3 py-7 ">
              <div className="p-4 rounded-[12px] bg-[#252525] text-[#929292] w-1/2">
                <input type="text" placeholder="Your e-mail address" className="outline-none"/>
              </div>
              <div className="p-4 rounded-[12px] text-[white] bg-[#965CFF] hover:bg-[#6B33CC] font-bold w-1/5">
